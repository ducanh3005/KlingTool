...
// Debug endpoint to test Kling download API response format
app.post('/api/debug-download', async (req, res) => {
    try {
        const { workId } = req.body;
        ...
        console.log(`Debug download for work ID: ${workId}`);
        ...
        console.log('Debug download response:', JSON.stringify(downloadResponse.data, null, 2));
        
        res.json({
            success: true,
            rawResponse: downloadResponse.data,
            responseType: typeof downloadResponse.data,
            hasResult: 'result' in downloadResponse.data,
            hasData: 'data' in downloadResponse.data,
            hasDownloadUrl: 'downloadUrl' in downloadResponse.data,
            hasDataDownloadUrl: downloadResponse.data.data && 'downloadUrl' in downloadResponse.data.data,
            message: 'Debug response format'
        });
